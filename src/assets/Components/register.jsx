...
function RegisterUser() {
  ...
  return (
    <div className="min-h-screen pt-20 sm:pt-24 md:pt-28 pb-10 sm:pb-12 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-[var(--background)]">
      <motion.div
      ...
      >
        <div className="minimal-card p-6 sm:p-8 md:p-10 lg:p-12 rounded-xl sm:rounded-2xl bg-[var(--surface)] shadow-sm">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-[var(--text-muted)] text-xs sm:text-sm">Create an account to start your library</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div className="space-y-1.5">
              <label className="text-xs sm:text-sm font-semibold text-[var(--text-muted)] ml-1">Full Name</label>
              <input
                type="text"
                name="name"
            ...
            <button
              ...
              className={`w-full btn-primary h-11 sm:h-12 text-sm sm:text-base mt-4 ${!isFormValid ? "opacity-50 grayscale cursor-not-allowed" : ""
                }`}
            >
              Create Account
            </button>
