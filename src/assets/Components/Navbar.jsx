  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        >
          <div className="w-8 h-8 bg-[var(--primary)] rounded-lg flex items-center justify-center text-[var(--primary-text)] transition-colors">
          ...
          <h1 className="text-xl font-semibold tracking-tight text-[var(--text-main)] group-hover:opacity-70 transition-opacity">
            MelodyHub
          </h1>
        </motion.div>

        {/* LINKS */}
        <ul className="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--text-muted)]">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-lg bg-[var(--surface-hover)] text-[var(--text-main)] transition-colors"
          ...
          {!token ? (
            <div className="hidden sm:flex items-center gap-3">
              <button
                className="text-sm font-medium text-[var(--text-muted)] hover:text-[var(--text-main)] transition-colors px-3 py-2"
            ...
            <button
              className="text-sm font-medium text-red-500 hover:text-red-400 transition-colors px-3 py-2 bg-red-500/5 rounded-lg border border-red-500/10"
